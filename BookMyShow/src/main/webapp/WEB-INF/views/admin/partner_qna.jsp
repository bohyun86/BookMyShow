...
<!--                                     리스트의 총 크기를 계산 -->
                                  ...
                                  <c:forEach var="userDTO" items="${partnerQnaList}">
            <c:forEach var="partnerQnaDTO" items="${userDTO.partnerDTO.partnerQnaDTO}">
                <tr>
                    <td>${userDTO.userName}</td>
                    <td>${partnerQnaDTO.title}</td>
                    <td>${partnerQnaDTO.content}</td>
                    <td>${partnerQnaDTO.createdAt}</td>
                    <td>${userDTO.partnerDTO.companyName}</td>
                    <td>
                        <c:choose>
