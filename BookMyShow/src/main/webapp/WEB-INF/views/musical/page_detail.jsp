    ...
    <div style="float: left; position:relative; width:482px; margin-right:20px; margin-top:30px; border-radius:10px;">
        <c:forEach var="musical_File" items="${musical_file}" varStatus="index" step="1">
            <c:if test="${index.last}">
                <img src="${pageContext.request.contextPath}/resources/upload/${musical_File.upload_path }/${musical_File.uuid}_${musical_File.file_name}"
                     style="width:482px; height: 482px; border-radius:10px;">
            </c:if>
        </c:forEach>
    </div>
