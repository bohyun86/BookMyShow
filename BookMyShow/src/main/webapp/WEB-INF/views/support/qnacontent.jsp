...
<main class="support-notice-write" id="notice-main">
    ...
    <form action="${pageContext.request.contextPath}/support/qnaupdate" class="supportForm" method="post" name="fr">
				<p class="notice_1">질문</p> <input type="text" name="question"  value="${supportqnaDTO.question }" readonly>				
				<div class="editer_content">
					    <p class="notice_2">답변</p> <textarea name="answer" rows="10" cols="30" readonly>${supportqnaDTO.answer }</textarea>
					    </div>
					<p class="btn_line txt_right">
		  <c:if test="${ ! empty sessionScope.userRole }">
          <c:if test="${sessionScope.userRole eq 'admin'}">
				<a href="${pageContext.request.contextPath}/support/qnaupdate?faq_id=${supportqnaDTO.faq_id}" class="btn_bbs1">자주 묻는 질문 수정</a>
		  </c:if>
		  </c:if>
