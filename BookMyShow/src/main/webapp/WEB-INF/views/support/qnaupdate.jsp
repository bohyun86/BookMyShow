...
<main class="support-notice-write" id="notice-main">
    ...
    <form action="${pageContext.request.contextPath}/support/qnaupdatePro" class="supportForm" method="post" name="fr">
    <input type="hidden" name="faq_id" value="${supportqnaDTO.faq_id}">
				<p class="notice_1">자주 묻는 질문 제목</p> <input type="text" name="question"  value="${supportqnaDTO.question }">				
				<div class="editer_content">
					    <p class="notice_2">자주 묻는 질문 내용</p> <textarea name="answer" rows="10" cols="30">${supportqnaDTO.answer }</textarea>
					    </div>
