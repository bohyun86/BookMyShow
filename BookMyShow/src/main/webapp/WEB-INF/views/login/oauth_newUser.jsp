...
<div class="w-100 min-vh-100 d-flex justify-content-center align-items-center bg-white">
    <form class="p-5" id="join-form" data-pageContext="${pageContext.request.contextPath}"
    method="post" action="${pageContext.request.contextPath}/oauth/kakao/joinPro">
        ...
        <div class="form-group pb-2 d-flex row align-items-stretch justify-content-center">
            <div class="input-group  px-0" id="id-input">
                <div class="input-group-prepend">
                    <span class="input-group-text border-0 bg-white">
                        <c:choose>
                            <c:when test="${user.oauth == 'kakao'}">
                                <img src="${pageContext.request.contextPath}/resources/images/login/circle_kakao.png" alt="naver"
                                     class="icon" style="width: 20px">
                            </c:when>
                            <c:otherwise>
                ...
                <input type="text" class="form-control border-0" name="userName" placeholder="아이디" autofocus value="${user.userName}"
                       style="font-weight: bolder;" disabled>
            </div>
            ...
            <div class="input-group  px-0" id="email-input">
               ...
               <i class="bi bi-envelope"></i>
                ...
                <input type="email" class="form-control border-0" name="email" placeholder="이메일" value="${user.email}">
            </div>
            ...
            <div class="input-group  px-0" id="name-input">
                ...
                <input type="text" class="form-control border-0" name="name" placeholder="이름" value="${user.name}">
            </div>
            ...
            <div class="input-group px-0" id="phone-input">
                ...
                <input type="text" class="form-control border-0" name="phoneNumber" placeholder="휴대폰번호" value="${user.phoneNumber}">
            </div>
...
<script src="${pageContext.request.contextPath}/resources/js/oauth-new-user.js"></script>
</body>
</html>