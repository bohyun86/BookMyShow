			...
			<div class="detail-card">
				...
				<div class="detail-row">
					<span class="detail-label">결제수단</span> <span class="detail-value">
						${payment.paymentMethod} <!-- 						<button --> <!-- 							class="btn btn-sm btn-outline-danger action-button receipt-button" -->
				...
				<div class="detail-row">
					<span class="detail-label">공제금액</span> <span class="detail-value">
						<c:if
							test="${not empty payment.paymentAmount and not empty payment.refundAmount}">
							<fmt:formatNumber
				...
				<div class="detail-row">
					<span class="detail-label">환불금액</span> <span class="detail-value">
						<c:if test="${not empty payment.refundAmount}">
							<fmt:formatNumber value="${payment.refundAmount}" type="currency"
								currencySymbol="₩" />
						</c:if>
					</span>
				</div>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<i class="bi bi-clock me-2"></i>밤12시 자정 기준
					</p>
					<ul>
						<li>7일 전: 전액 환불</li>
						<li>6~4일 전: 10% 공제</li>
