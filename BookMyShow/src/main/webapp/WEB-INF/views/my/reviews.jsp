	...
	<main id="board-main">
		...
		<section id="board-content">
			...
			<div class="review-summary">
				<span>총 리뷰 수: ${reviewCount != null ? reviewCount : '3'}</span> <span>평균
					평점: <span class="average-rating">${averageRating != null ? averageRating : '4.2'}</span>/5
				</span>
			</div>
					...
					<c:otherwise>
						...
						<div class="review-item">
							...
							<div class="review-body">
								...
								<p class="review-content">감동적인 스토리와 훌륭한 음악이 어우러진 최고의
									공연이었습니다. 배우들의 열연에 깊은 감동을 받았습니다.</p>
								<img
									src="${pageContext.request.contextPath}/resources/images/review_example1.jpg"
									class="review-image" alt="레미제라블 공연 사진">
							</div>
							<div class="review-footer">
								<button class="btn btn-outline-primary btn-sm edit-review"
									data-review-id="1">수정</button>
								<button class="btn btn-outline-danger btn-sm delete-review"
									data-review-id="1">삭제</button>
							</div>
						</div>
						<div class="review-item">
							<div class="review-header">
							...
							<div class="review-body">
								...
								<p class="review-content">환상적인 무대와 음악, 배우들의 뛰어난 연기력까지 모든 것이
									완벽했습니다. 꼭 다시 보고 싶은 작품입니다!</p>
							</div>
							<div class="review-footer">
								<button class="btn btn-outline-primary btn-sm edit-review"
									data-review-id="2">수정</button>
								<button class="btn btn-outline-danger btn-sm delete-review"
									data-review-id="2">삭제</button>
							</div>
						</div>
					</c:otherwise>
				</c:choose>
